<?php
	...
	/**
	 *	Response web-service contains examples page.
	 *
...
<html>
<head>
	<title>GeoFeatures documentation - Examples - Contains</title>
					...
					<ul class="nav side-nav">
						...
						<li>
							...
							<ul class="nav">
								...
								<li><a href="#contains" class="current">Contains</a></li>
